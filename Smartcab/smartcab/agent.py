...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5):
        ...
        #self.a=0.9999 for sigmoid decay
        self.trial_num=0
        #self.a=0.3 for sigmoid decay
        self.a=0.015 #for exp
    ...
    def reset(self, destination=None, testing=False):
        ...
        #self.epsilon -= 0.05 #testing parameters
        #self.epsilon = self.a**self.trial_num
        #self.epsilon = math.cos(self.a*self.trial_num)
        #self.epsilon =self.epsilon*(self.a**self.trial_num)
...
def run():
    ...
    agent = env.create_agent(LearningAgent, learning=True, alpha=0.8, epsilon=0.8)
